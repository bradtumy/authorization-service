...
// Provider is an identity provider backed by local YAML files.
...
// New creates a new local identity provider. If persist is true, users
// are read from and written to configs/<tenantID>/users.yaml.
